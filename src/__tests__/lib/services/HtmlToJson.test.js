...
describe('#htmlToJson', () => {
  ...
  describe('pass a html string containing a empty p tag', () => {
    test('returns a paragraph element with empty text children', () => {
      const input = `<p></p>`;
  ...
  describe("pass a html string containing img tag inside paragraph tag without any text", () => {
    test('returns one image element', () => {
      const input = `<p><img src="data:image/png;base64,"></p>`;
